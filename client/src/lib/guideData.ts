      ...
      },
      {
        ...
        links: [
          ...
          },
          {
            ...
            label: "UniFi WiFi SSID and AP Settings — WPA3",
            url: "https://help.ui.com/hc/en-us/articles/32065480092951-UniFi-WiFi-SSID-and-AP-Settings-Overview",
            description: "Official UniFi help: in the UniFi Network console go to WiFi > select your SSID > Security. Set the security protocol to WPA3 or WPA2/WPA3 Mixed Mode for backward compatibility.",
          },
        ],
      },
    ],
    ...
    content: [
      ...
      },
      {
        ...
        links: [
          ...
          {
            brand: "Ubiquiti UniFi",
            label: "Best Practices: Guest WiFi with VLAN Isolation",
            url: "https://help.ui.com/hc/en-us/articles/23948850278295-Best-Practices-Guest-WiFi",
            description: "Official Ubiquiti guide: go to Settings > Networks, create a new network, enable Network Isolation, then create a dedicated WiFi SSID and assign it to that network. UniFi supports true VLAN-based isolation — more powerful than consumer guest modes.",
          },
        ],
      },
    ],
    ...
    content: [
      ...
      },
      {
        ...
        links: [
          ...
          {
            brand: "Ubiquiti UniFi",
            label: "UniFi Gateway — UPnP",
            url: "https://help.ui.com/hc/en-us/articles/12648697125783-UniFi-Gateway-UPnP",
            description: "Official Ubiquiti help: UPnP is disabled by default on UniFi gateways. To verify, go to UniFi Network > Settings > Internet > Advanced and confirm UPnP is toggled off. Ubiquiti recommends keeping it disabled.",
          },
        ],
      },
    ],
    ...
    content: [
      ...
      },
      {
        ...
        links: [
          ...
          {
            brand: "Ubiquiti UniFi",
            label: "Creating Virtual Networks (VLANs) — UniFi",
            url: "https://help.ui.com/hc/en-us/articles/9761080275607-Creating-Virtual-Networks-VLANs",
            description: "With UniFi, connect your server to the isolated VLAN SSID you created. UniFi's VLAN isolation is more robust than consumer guest modes — your server will be fully separated at the network layer from all other VLANs.",
          },
        ],
      },
    ],
